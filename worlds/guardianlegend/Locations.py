from typing import Callable, Dict, NamedTuple, Optional, List, Tuple
...
location_table: Dict[str, TGLLocationData] = {
    # Area 0 - 12 locs
    "Corridor 1 (X6 Y10)":         TGLLocationData("Area 0",  "Corridor",  TGL_LOCID_BASE+3001, (0x9, 0x1 )),
    #"Corridor 1 Fleepa (X6 Y10)":  TGLLocationData("Area 0",  "Corridor",  TGL_LOCID_BASE+1002),
    "Corridor 1 Bonus":            TGLLocationData("Area 0",  "Corridor",  TGL_LOCID_BASE+4001),
    ...
    # Area 1 - 6 locs
    "Corridor 11 (X1 Y8)":         TGLLocationData("Area 1",  "Corridor",  TGL_LOCID_BASE+3011,        (0xA, 0x4 )),
    "Corridor 11 Bonus":           TGLLocationData("Area 1",  "Corridor",  TGL_LOCID_BASE+4011),
    ...
    # Area 2 - 7 locs
    "Corridor 2 (X2 Y16)":            TGLLocationData("Area 2",  "Corridor",  TGL_LOCID_BASE+3002, (0x9, 0x2 )),
    "Corridor 2 Bonus":               TGLLocationData("Area 2",  "Corridor",  TGL_LOCID_BASE+4002),
    #"Corridor 2 Crawdaddy (X2 Y16)":  TGLLocationData("Area 2",  "Corridor",  TGL_LOCID_BASE+1202),
    "Corridor 12 (X4 Y15)":           TGLLocationData("Area 2",  "Corridor",  TGL_LOCID_BASE+3012, (0xA, 0x8 )),
    "Corridor 12 Bonus":              TGLLocationData("Area 2",  "Corridor",  TGL_LOCID_BASE+4012, (0xA, 0x8 )),
    ...
    # Area 3 - 6 locs
    "Corridor 3 (X4 Y20)":            TGLLocationData("Area 3",  "Corridor",  TGL_LOCID_BASE+3003, (0x9, 0x4 )),
    "Corridor 3 Bonus":               TGLLocationData("Area 3",  "Corridor",  TGL_LOCID_BASE+4003),
    #"Corridor 3 Optomon (X4 Y20)":    TGLLocationData("Area 3",  "Corridor",  TGL_LOCID_BASE+1302),
    "Corridor 13 (X5 Y20)":           TGLLocationData("Area 3",  "Corridor",  TGL_LOCID_BASE+3013, (0xA, 0x10)),
    "Corridor 13 Bonus":              TGLLocationData("Area 3",  "Corridor",  TGL_LOCID_BASE+4013),
    ...
    # Area 4 - 8 locs
    "Corridor 4 (X20 Y0)":            TGLLocationData("Area 4",  "Corridor",  TGL_LOCID_BASE+3004, (0x9, 0x8 )),
    "Corridor 4 Bonus":               TGLLocationData("Area 4",  "Corridor",  TGL_LOCID_BASE+4004),
    #"Corridor 4 Teramute (X20 Y0)":   TGLLocationData("Area 4",  "Corridor",  TGL_LOCID_BASE+1402),
    "Corridor 14 (X17 Y4)":           TGLLocationData("Area 4",  "Corridor",  TGL_LOCID_BASE+3014, (0xA, 0x20)),
    "Corridor 14 Bonus":              TGLLocationData("Area 4",  "Corridor",  TGL_LOCID_BASE+4014),
    ...
    # Area 5 - 7 locs
    "Corridor 5 (X23 Y4)":            TGLLocationData("Area 5",  "Corridor",  TGL_LOCID_BASE+3005, (0x9, 0x10)),
    "Corridor 5 Bonus":               TGLLocationData("Area 5",  "Corridor",  TGL_LOCID_BASE+4005),
    "Corridor 15 (X21 Y8)":           TGLLocationData("Area 5",  "Corridor",  TGL_LOCID_BASE+3015, (0xA, 0x40)),
    "Corridor 15 Bonus":              TGLLocationData("Area 5",  "Corridor",  TGL_LOCID_BASE+4015),
    ...
    # Area 6 - 8 locs
    "Corridor 6 (X16 Y11)":           TGLLocationData("Area 6",  "Corridor",  TGL_LOCID_BASE+3006, (0x9, 0x20)),
    "Corridor 6 Bonus":               TGLLocationData("Area 6",  "Corridor",  TGL_LOCID_BASE+4006),
    #"Corridor 6 Glider (X16 Y11)":    TGLLocationData("Area 6",  "Corridor",  TGL_LOCID_BASE+1602),
    "Corridor 16 (X18 Y13)":          TGLLocationData("Area 6",  "Corridor",  TGL_LOCID_BASE+3016, (0xA, 0x80)),
    "Corridor 16 Bonus":              TGLLocationData("Area 6",  "Corridor",  TGL_LOCID_BASE+4016),
    ...
    # Area 7 - 9 locs
    "Corridor 7 (X19 Y23)":           TGLLocationData("Area 7",  "Corridor",  TGL_LOCID_BASE+3007, (0x9, 0x40)),
    "Corridor 7 Bonus":               TGLLocationData("Area 7",  "Corridor",  TGL_LOCID_BASE+4007),
    "Corridor 17 (X18 Y19)":          TGLLocationData("Area 7",  "Corridor",  TGL_LOCID_BASE+3017, (0xB, 0x1 )),
    "Corridor 17 Bonus":              TGLLocationData("Area 7",  "Corridor",  TGL_LOCID_BASE+4017),
    ...
    # Area 8 - 8 locs
    "Corridor 8 (X10 Y16)":           TGLLocationData("Area 8",  "Corridor",  TGL_LOCID_BASE+3008, (0x9, 0x80)),
    "Corridor 8 Bonus":               TGLLocationData("Area 8",  "Corridor",  TGL_LOCID_BASE+4008),
    #"Corridor 8 Grimgrin (X10 Y16)":  TGLLocationData("Area 8",  "Corridor",  TGL_LOCID_BASE+1802),
    "Corridor 18 (X11 Y19)":          TGLLocationData("Area 8",  "Corridor",  TGL_LOCID_BASE+3018, (0xB, 0x2 )),
    "Corridor 18 Bonus":              TGLLocationData("Area 8",  "Corridor",  TGL_LOCID_BASE+4018),
    ...
    # Area 9 - 9 locs
    "Corridor 9 (X2 Y2)":             TGLLocationData("Area 9",  "Corridor",  TGL_LOCID_BASE+3009, (0xA, 0x1 )),
    "Corridor 9 Bonus":               TGLLocationData("Area 9",  "Corridor",  TGL_LOCID_BASE+4009),
    #"Corridor 9 Eyegore (X2 Y2)":     TGLLocationData("Area 9",  "Corridor",  TGL_LOCID_BASE+1902),
    "Corridor 19 (X4 Y4)":            TGLLocationData("Area 9",  "Corridor",  TGL_LOCID_BASE+3019, (0xB, 0x4 )),
    "Corridor 19 Bonus":              TGLLocationData("Area 9",  "Corridor",  TGL_LOCID_BASE+4019),
    ...
    # Area 10 - 6 locs
    "Corridor 10 (X11 Y0)":            TGLLocationData("Area 10", "Corridor",  TGL_LOCID_BASE+3010, (0xA, 0x2 )),
    "Corridor 10 Bonus":               TGLLocationData("Area 10", "Corridor",  TGL_LOCID_BASE+4010),
    "Corridor 20 (X11 Y5)":            TGLLocationData("Area 10", "Corridor",  TGL_LOCID_BASE+3020, (0xB, 0x8 )),
    "Corridor 20 Bonus":               TGLLocationData("Area 10", "Corridor",  TGL_LOCID_BASE+4020),
