...
#                  A/B Shop locations may get removed as a solution to shop check problem 
# Note: For LOCID, 1000s is Ground drops, 2000s is Shops, 3000s is Corridors (see Rom.py)
# Total locations: 86
location_table: Dict[str, TGLLocationData] = {
    ...
    "A2 Claw Launcher (X5 Y17)":      TGLLocationData("Area 2",  "Miniboss",  TGL_LOCID_GROUND_BASE+0x0f, (0x1, 0x8 )),
    ...
    "A8 Leech Flower (X12 Y18)":      TGLLocationData("Area 8",  "Miniboss",  TGL_LOCID_GROUND_BASE+0x1b, (0x3, 0x4 )),
